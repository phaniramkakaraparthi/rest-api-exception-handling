package phani.spring.restapiexceptionhandling.controller;
...
import phani.spring.restapiexceptionhandling.repository.BookRepository;
...
public class BookController {
    ...
    public Book getBookById(@PathVariable long id) {
        ...
        if (!book.isPresent()) {
            throw new ResponseStatusException(FORBIDDEN, String.format("No resource found for id (%s)", id));
        }
        return book.get();
    }
